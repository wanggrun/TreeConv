...
class Model(ImageNetModel):
    ...
    def get_logits(self, image):
        with argscope([Conv, Conv2D, AvgPooling, MaxPooling, GlobalAvgPooling, BatchNorm, LayerNorm], data_format=self.data_format):
    ...
    if args.eval:
        ...
        if args.fake:
            ...
            logger.set_logger_dir(
                os.path.join('/data0/wangguangrun/tensorflow_log/train_log',
